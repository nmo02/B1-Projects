function example7_3%%%% Mechanical equilibrium 3D and 2D - bending cantilever beam
% plane strain vs 3dP1 elements
...
%% ============ ========== PART 1 (3D) ========== ============
    ...
    function [u2_E,smpGrad,nodeCoords]=go3d(elementSize,smpPts)
        ...
        isDirichlet_E=[0 0 0; 0 0 1; ... %bottom and top
        ...
        hold on;
        drawElementsInterp(shift+nodeCoords+u2_E*factor,cell2mat(boundaryIEN),bndElementType,s2(1,:),.6);
...
%         CMatrix_E=properties.CPlaneStressFull;
        ...
        [smpEl,smpNatCoords] = meshGetNatural(nodeCoords,IEN,elementType,INE,smpPts(:,1:2));
        smpGrad=recoveryEvaluateGradients(u2_E,nodeCoords,IEN,elementType,smpEl,smpNatCoords);
