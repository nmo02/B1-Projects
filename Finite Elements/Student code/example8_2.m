function [ts,u,v,a]=example8_2(elementSize,tfinal)
% Oscilation of cantilever beam - explicit Newmark's method
% Run example8_main
...
doplot=1;
displayevery=60; % Every k-th timestep to plot
factor=1e5;
%% ===== Problem Parameters ===== %
...
L=2*elSizeX*elSizeY/(elSizeX+elSizeY+sqrt(elSizeX^2+elSizeY^2)); % characteristic element length
dt=0.9*L/cp;
