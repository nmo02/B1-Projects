...
prescribedDoF=[leftXDoF; leftYDoF; rightXDoF; rightYDoF]; % Constrain x and y on left and right edges
...
u_prescribed(leftXDoF) = 0; % Zero x-displacement for left edge
u_prescribed(leftYDoF) = 0; % Zero y-displacement for left edge
u_prescribed(rightXDoF) = 0.0000001; % Apply a stretch in the x-direction (0.1 units)
u_prescribed(rightYDoF) = 0.0000001; % Apply a small upward displacement (0.05 units)
